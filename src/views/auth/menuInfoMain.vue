    ...
    <div>
      ...
      <el-table  :data="tableData" @selection-change="handleSelectionChange" border fit height="520px" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}" header-align="center">
        <el-table-column type="selection" fixed ></el-table-column>
         ...
         <el-table-column prop="menuPid" label="菜单父ID" min-width="150px"></el-table-column>
         <el-table-column prop="menuName" label="菜单名" min-width="150px"></el-table-column>
         <el-table-column prop="menuStatus" label="菜单状态" min-width="150px"></el-table-column>
         <el-table-column prop="remark" label="备注" min-width="150px"></el-table-column>
         <el-table-column prop="donMenuInfoId" label="主键" min-width="150px"></el-table-column>
            ...
            <el-row>
                <el-col :span="10">
                    <el-form-item label="菜单ID" prop="menuId">
                        <el-input v-model="insForm.menuId" placeholder="菜单ID"/>
                    </el-form-item>
                </el-col>
                <el-col :span="10">
                    <el-form-item label="菜单父ID" prop="menuPid">
                        <el-input v-model="insForm.menuPid" placeholder="菜单父ID"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="10">
                    <el-form-item label="菜单名" prop="menuName">
                        <el-input v-model="insForm.menuName" placeholder="菜单名"/>
                    </el-form-item>
                </el-col>
                <el-col :span="10">
                    <el-form-item label="菜单状态" prop="menuStatus">
                        <el-input v-model="insForm.menuStatus" placeholder="菜单状态"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                ...
                <el-col :span="10">
                    <el-form-item label="主键" prop="donMenuInfoId">
                        <el-input v-model="insForm.donMenuInfoId" placeholder="主键"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
      ...
      <el-dialog :title="'修改'+titleName" :visible.sync="updVisible" width="55%">
        <el-form ref="updRef" :model="updForm" :rules="updRules" label-position="right" label-width="100px">
            <el-row>
                <el-col :span="10">
                    <el-form-item label="菜单ID" prop="menuId">
                        <el-input v-model="updForm.menuId" placeholder="菜单ID"/>
                    </el-form-item>
                </el-col>
                <el-col :span="10">
                    <el-form-item label="菜单父ID" prop="menuPid">
                        <el-input v-model="updForm.menuPid" placeholder="菜单父ID"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="10">
                    <el-form-item label="菜单名" prop="menuName">
                        <el-input v-model="updForm.menuName" placeholder="菜单名"/>
                    </el-form-item>
                </el-col>
                <el-col :span="10">
                    <el-form-item label="菜单状态" prop="menuStatus">
                        <el-input v-model="updForm.menuStatus" placeholder="菜单状态"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                ...
                <el-col :span="10">
                    <el-form-item label="主键" prop="donMenuInfoId">
                        <el-input v-model="updForm.donMenuInfoId" placeholder="主键"/>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
  ...
  methods: {
    ...
    init () {
      ...
      var url = '/api/web/menuInfo/query'
    ...
    delBatch () {
      if (this.multipleSelection.length != 0) {
        this.$confirm('请确认是否删除?', '提示', {
          ...
          var url = '/api/web/menuInfo/delete'

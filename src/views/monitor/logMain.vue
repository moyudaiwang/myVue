  ...
  <div class="main-app">
    ...
    <div>
      ...
      <el-table  :data="tableData" @selection-change="handleSelectionChange" border fit height="520px" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}" header-align="center">
        ...
        <el-table-column prop="logId" label="日志ID" min-width="150px"></el-table-column>
        ...
        <el-table-column prop="operateType" label="操作类型" min-width="150px"></el-table-column>
        <el-table-column prop="operateDate" label="操作时间" min-width="150px"></el-table-column>
        <el-table-column prop="firstModule" label="一级模块" min-width="150px"></el-table-column>
        <el-table-column prop="secondModule" label="二级模块" min-width="150px"></el-table-column>
        <el-table-column prop="thirdModule" label="三级模块" min-width="150px"></el-table-column>
        <el-table-column prop="usePoint" label="功能点" min-width="150px"></el-table-column>
        <el-table-column prop="operateResult" label="操作结果" min-width="150px"></el-table-column>
        <el-table-column prop="eventScene" label="案发现场" min-width="150px"></el-table-column>
          ...
          <el-row>
            <el-col :span="10">
              <el-form-item label="日志ID" prop="logId">
                <el-input v-model="insForm.logId" placeholder="日志ID"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="IP" prop="ip">
                <el-input v-model="insForm.ip" placeholder="IP"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-col :span="10">
              <el-form-item label="操作类型" prop="operateType">
                <el-input v-model="insForm.operateType" placeholder="操作类型"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="操作时间" prop="operateDate">
                <el-date-picker type="date" placeholder="操作时间" v-model="insForm.operateDate" value-format="yyyy-MM-dd" style="width: 300px;"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="一级模块" prop="firstModule">
                <el-input v-model="insForm.firstModule" placeholder="一级模块"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="二级模块" prop="secondModule">
                <el-input v-model="insForm.secondModule" placeholder="二级模块"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="三级模块" prop="thirdModule">
                <el-input v-model="insForm.thirdModule" placeholder="三级模块"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="功能点" prop="usePoint">
                <el-input v-model="insForm.usePoint" placeholder="功能点"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="操作结果" prop="operateResult">
                <el-input v-model="insForm.operateResult" placeholder="操作结果"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="案发现场" prop="eventScene">
                <el-input v-model="insForm.eventScene" placeholder="案发现场"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
      ...
      <el-dialog :title="'修改'+titleName" :visible.sync="updVisible" width="55%">
        <el-form ref="updRef" :model="updForm" :rules="updRules" label-position="right" label-width="100px">
          <el-row>
            <el-col :span="10">
              <el-form-item label="日志ID" prop="logId">
                <el-input v-model="updForm.logId" placeholder="日志ID"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="IP" prop="ip">
                <el-input v-model="updForm.ip" placeholder="IP"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
          ...
          <el-row>
            ...
            <el-col :span="10">
              <el-form-item label="操作类型" prop="operateType">
                <el-input v-model="updForm.operateType" placeholder="操作类型"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="操作时间" prop="operateDate">
                <el-date-picker type="date" placeholder="操作时间" v-model="updForm.operateDate" value-format="yyyy-MM-dd" style="width: 300px;"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="一级模块" prop="firstModule">
                <el-input v-model="updForm.firstModule" placeholder="一级模块"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="二级模块" prop="secondModule">
                <el-input v-model="updForm.secondModule" placeholder="二级模块"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="三级模块" prop="thirdModule">
                <el-input v-model="updForm.thirdModule" placeholder="三级模块"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="功能点" prop="usePoint">
                <el-input v-model="updForm.usePoint" placeholder="功能点"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="操作结果" prop="operateResult">
                <el-input v-model="updForm.operateResult" placeholder="操作结果"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="10">
              <el-form-item label="案发现场" prop="eventScene">
                <el-input v-model="updForm.eventScene" placeholder="案发现场"/>
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="备注" prop="remark">
...
export default {
  ...
  methods: {
    ...
    // 初始化
    init () {
      let donLogInfoEntity = {
        queryName: this.param.queryName,
        pageNum: this.param.pageNum,
        pageSize: this.param.pageSize
      }
      var url = '/api/web/logInfo/query'
      this.$axios.post(url, donLogInfoEntity).then(res => {
    ...
    // 新增
    ins () {
      let donLogInfoEntity = this.insForm
      var url = '/api/web/logInfo/insert'
      this.$axios.post(url, donLogInfoEntity).then(res => {
        if (res.data.code == '100200') {
    ...
    // 修改
    upd () {
      let donLogInfoEntity = this.updForm
      var url = '/api/web/logInfo/update'
      this.$axios.post(url, donLogInfoEntity).then(res => {
        if (res.data.code == '100200') {
    ...
    delBatch () {
      if (this.multipleSelection.length != 0) {
        this.$confirm('请确认是否删除?', '提示', {
          ...
          var url = '/api/web/logInfo/delete'
